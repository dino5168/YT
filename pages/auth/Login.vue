<template>
    ...
    <div
        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div v-if="!loading">
                ...
                <form @submit.prevent="handleEmailLogin" class="space-y-6">
                    <div>
                        <label for="email" class="block mb-2 font-medium text-gray-700">電子郵件</label>
                    ...
                    <div>
                        <label for="password" class="block mb-2 font-medium text-gray-700">密碼</label>
                ...
                <div class="mt-6 text-center text-sm text-gray-600">
                    <NuxtLink to="/forgot-password" class="text-blue-600 hover:underline">忘記密碼？</NuxtLink>
                    <span class="mx-2">|</span>
                    <NuxtLink to="/register" class="text-blue-600 hover:underline">註冊新帳號</NuxtLink>
                </div>
                ...
                <div class="mt-8 border-t pt-6">
                    ...
                    <div class="flex justify-center space-x-4">
                        ...
                        <ClientOnly>
                            ...
                            <button @click="handleGoogleOAuthRedirect"
                                ...
                                <img src="/assets/icons/google.svg" alt="Facebook" class="w-5 h-5 mr-2" />
                                Google
                            </button>
                            <button
                                class="flex items-center border hover:cursor-pointer border-gray-300 rounded-md px-4 py-2 hover:bg-gray-100 transition"
        ...
        <div class="mt-8 text-center text-sm text-gray-500">
            <p>登入即表示您同意我們的
                <NuxtLink to="/terms" class="text-blue-600 hover:underline">使用條款</NuxtLink>
                和
                <NuxtLink to="/privacy" class="text-blue-600 hover:underline">隱私政策</NuxtLink>
            </p>
        </div>
