  ...
  <div class="p-4">
    ...
    <div v-show="isShow" class="mb-4 p-4 bg-gray-50 rounded-sm">
      <Caption color="text-blue-600"
        >代碼檔-<span :class="operationColor">{{
          operationState
        }}</span></Caption
      >
      <div class="flex items-center mb-4 w-80">
        <label class="text-sm font-medium mr-3 whitespace-nowrap"
          >選擇代碼分類：</label
        >
        <ComboBoxApi
          v-model="combox_selectedValue"
          api-url="CODES_CATGORY_LIST"
          placeholder="請選擇代碼分類.."
          class="flex-1" />
      </div>
