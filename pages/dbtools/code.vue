<template>
  ...
  >
    ...
    <div id="editForm" class="flex space-x-4 px-4 py-1">
        <FormInput label="目錄" class="w-64" placeholder="目錄..." labelcolor="text-red-600"></FormInput>
        <FormInput label="代碼" class="w-64" placeholder="代碼..." labelcolor="text-red-600"></FormInput>
        <FormInput label="名稱" class="w-64" placeholder="名稱..." labelcolor="text-red-600"> </FormInput>
        <FormInput label="描述" class="w-64" placeholder="描述..." labelcolor="text-red-600"></FormInput>
