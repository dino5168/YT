...
const props = defineProps<{
    items: Array<{
        ...
        nav_item_id: string,
        sort_order: string,
        dropdown?: Array<{ label: string; href?: string, id: string, type: string, nav_item_id: string, sort_order: string }>
    }>
}>()

const emit = defineEmits<{
    (e: 'select', item: { label: string; href?: string, id: string, type: string, nav_item_id: string, sort_order: string }): void
}>()
