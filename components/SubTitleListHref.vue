  ...
  <div class="subtitle-list h-full custom-scrollbar overflow-y-auto">
    <div class="p-4 space-y-2">
      <div
        ...
        :key="index"
        :data-index="index"
        class="p-2 cursor-pointer transition-colors rounded"
        :class="{
        ...
        <p class="text-yellow-300 text-md">{{ subtitle.en_text }}</p>
  ...
  if (activeIndex.value >= 0) {
    nextTick(() => {
      ...
      const scrollContainer =
        subtitleListEl ||
        (subtitleListEl &&
          (subtitleListEl as Element).closest('[class*="overflow-y-auto"]'));
          ...
          switch (props.scrollPosition || "top") {
            ...
            case "center":
              scrollTop =
                ...
                (targetElement as HTMLElement).clientHeight / 2;
              break;
            case "bottom":
              scrollTop =
                (targetElement as HTMLElement).offsetTop -
